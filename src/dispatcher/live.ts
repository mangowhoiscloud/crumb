 ...
 */
const PER_SPAWN_TIMEOUT_MS =
  Number(process.env.CRUMB_PER_SPAWN_TIMEOUT_MS) || 15 * 60 * 1000; // 15 min — hard wall-clock ceiling
const PER_SPAWN_IDLE_TIMEOUT_MS =
  Number(process.env.CRUMB_PER_SPAWN_IDLE_MS) || 90 * 1000; // 90 s — kill on no stdout for this long
